...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-2-1.png)
...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-4-1.png)
...
p <- ggplot(cars) +
  aes(x=speed, y=dist) +
  geom_point() +
  geom_smooth(method="lm", se=FALSE) + labs(title="Stopping distance of old cars", subtitle= "Data from the `cars` object", x="Speed (mph)", y="Distance (ft)")
```
...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-6-1.png)
...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-7-1.png)
...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-9-1.png)
...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-11-1.png)
...
ggplot(genes) +
  aes(Condition1, Condition2, col=State) +
  geom_point() + 
  scale_colour_manual(values=c("pink", "gray", "brown")) + theme_bw()
```

![](class-05-pdf_files/figure-commonmark/unnamed-chunk-12-1.png)
...
```
    ...
    <ggplot2::labels> List of 3
     ...
     $ y    : chr "Drug"
     $ title: chr "Gene Expression Changes upon GLP-1 drug"
...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-15-1.png)
...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-16-1.png)
...
![](class-05-pdf_files/figure-commonmark/unnamed-chunk-22-1.png)
